...
技巧文档的 frontmatter、正文模板和长示例已拆到 `easysdd/reference/tricks-reference.md`。本技能只保留判断与流程规则：
...
完整示例已拆到 `easysdd/reference/tricks-reference.md`。本技能正文不再内嵌长示例，避免技巧流程被示例淹没。
