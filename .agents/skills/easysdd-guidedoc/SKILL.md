...
| 情境 | 说明 |
|---|---|
| feature-acceptance 结束后 | 验收通过后，按 `easysdd-core/reference/shared-conventions.md` 的收尾推荐执行：第 2 节有接口变更 → 推送"需要更新 dev-guide 吗？"；第 1 节有用户可见行为变更 → 推送"需要更新 user-guide 吗？" |
...
| 来源工作流 | 关系说明 |
|---|---|
| `easysdd-feature-acceptance` | 验收结束后按 `easysdd-core/reference/shared-conventions.md` 主动推送：有接口变更推 dev-guide，有用户可见行为变更推 user-guide |
